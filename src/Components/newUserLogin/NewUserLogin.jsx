    ...
    return (  
        <form  onSubmit={formik.handleSubmit}>
                    ...
                    <div className={LoginStyles.group}>
                        <p dir="rtl">ایمیل : </p>
                        <input type="text" onChange={formik.handleChange} name='email' placeholder="ایمیل خود را وارد کنید..." onBlur={formik.handleBlur} dir="rtl"/>
                        {formik.errors.email && formik.touched.email && <p className={LoginStyles.errorText} style={{fontSize:'13px'}}>{formik.errors.email}</p>}

                    </div>

                    <div className={LoginStyles.group}>
                        <p dir="rtl">رمز عبور : </p>
                        <input type="text" onChange={formik.handleChange} name='password' placeholder="رمز عبور خود را وارد کنید..." onBlur={formik.handleBlur} dir="rtl"/>
                        {formik.errors.password && formik.touched.password && <p className={LoginStyles.errorText} style={{fontSize:'13px'}}>{formik.errors.password}</p>}
